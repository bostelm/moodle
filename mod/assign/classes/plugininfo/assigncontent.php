...
/**
 * Assign content subplugin info class.
 *
 * @package   mod_assign
...
class assigncontent extends base {
    ...
    public static function get_enabled_plugins() {
        ...
        $plugins = core_plugin_manager::instance()->get_installed_plugins('assigncontent');
        if (!$plugins) {
            return array();
        }
        $installed = array();
        foreach ($plugins as $plugin => $version) {
            $installed[] = 'assigncontent_'.$plugin;
        }
    ...
    public static function get_manage_url() {
        return new moodle_url('/mod/assign/adminmanageplugins.php', array('subtype' => 'assigncontent'));
    }
    ...
    public function uninstall_cleanup() {
        ...
        $DB->delete_records('assign_plugin_config', array('plugin' => $this->name, 'subtype' => 'assigncontent'));
