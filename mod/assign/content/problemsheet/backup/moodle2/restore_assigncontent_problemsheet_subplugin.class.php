 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assigncontent_problemsheet_subplugin extends restore_subplugin {
    ...
    protected function define_assign_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/content_problemsheet');
    ...
    /**
     * Processes one content_problemsheet element
     * @param mixed $data
     * @return void
     */
    public function process_assigncontent_problemsheet_assign($data) {
        // A dummy.
    }

    protected function after_execute_assign() {
        $this->add_related_files('assigncontent_problemsheet', 'problemsheets', null);
    }
